...
public class Home {
	...
	public double computeCommission() {
		return (liability * 0.3) + ((dwelling + contents) * 0.2);
	}
	
	// toString
	/**
	 * Name (Last, First): Doe, John
	 * House square footage: 1000 sqft
	 * Dwelling coverage: $100000.00
	 * Contents coverage: $25000.00
	 * Liability coverage: $50000.00
	 * Agent commission: $40000.00
	 */
	public String toString() {
		DecimalFormat df = new DecimalFormat("$###,###,###.00");
		return "Home Policy\n----------\nName: " + lName + ", " + fName + "\nHouse square footage: " + footage + " sqft\nDwelling coverage: " + df.format(dwelling) + "\nContents coverage: " + df.format(contents) + "\nLiability coverage: " + df.format(liability) + "\nAgent commission: " + df.format(computeCommission()) + "\n\n";
	}
